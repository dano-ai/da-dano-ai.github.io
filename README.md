...
Q. 개발은 얼마나 해야 하나요?
> A. 이 또한 현재의 회사 상황과 비즈니스 목표, 개발 자원의 여유 등에 따라 달라집니다. 데이터 파이프라인과 마케팅 자동화 솔루션을 설계할 때 써드파티 솔루션을 사용함으로써 개발 작업을 줄이면서도 원하는 효과를 달성할 수 있기 때문에 개발 자원의 여유와 전사적 개발 정책에 따라 능동적으로 옵션을 선택할 수 있습니다. 다만 최소한 써드파티 솔루션을 연동하는 작업은 개발팀의 지원이 필요합니다.
